...
public final class CataclysmJigsawStructure extends Structure {
    ...
    public static final Codec<CataclysmJigsawStructure> CODEC = validate(RecordCodecBuilder.mapCodec((p_227640_) -> {
    ...
    private static DataResult<CataclysmJigsawStructure> verifyRange(CataclysmJigsawStructure p_286886_) {
        ...
        int i = b0;
        return p_286886_.maxDistanceFromCenter + i > 128 ? DataResult.error("Structure size including terrain adaptation must not exceed 128") : DataResult.success(p_286886_);
    }
