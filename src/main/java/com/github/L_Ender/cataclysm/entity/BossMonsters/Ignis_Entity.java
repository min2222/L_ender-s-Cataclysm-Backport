...
public class Ignis_Entity extends Boss_monster {
    ...
    private static final EntityDataAccessor<Integer> HELD_ENTITY = SynchedEntityData.defineId(Ignis_Entity.class, EntityDataSerializers.INT);
