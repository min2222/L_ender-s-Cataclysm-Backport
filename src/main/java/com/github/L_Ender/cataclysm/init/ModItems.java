...
public class ModItems {
    ...
    public static final RegistryObject<Item> ANCIENT_SPEAR = ITEMS.register("ancient_spear",
            () -> new Ancient_Spear(new Item.Properties().tab(Cataclysm.TAB).stacksTo(1).rarity(Rarity.EPIC).fireResistant().durability(1800)));
    ...
    public static final RegistryObject<Item> BONE_REPTILE_HELMET = ITEMS.register("bone_reptile_helmet",
            () -> new Bone_Reptile_Armor(Armortier.BONE_REPTILE, EquipmentSlot.HEAD, new Item.Properties().tab(Cataclysm.TAB)));

    public static final RegistryObject<Item> BONE_REPTILE_CHESTPLATE = ITEMS.register("bone_reptile_chestplate",
            () -> new Bone_Reptile_Armor(Armortier.BONE_REPTILE, EquipmentSlot.CHEST, new Item.Properties().tab(Cataclysm.TAB)));
    ...
    public static final RegistryObject<Item> MUSIC_DISC_THE_LEVIATHAN = ITEMS.register("music_disc_the_leviathan",
            () -> new RecordItem(14, ModSounds.LEVIATHAN_MUSIC,new Item.Properties().tab(Cataclysm.TAB).stacksTo(1).rarity(Rarity.EPIC).fireResistant(), 291 * 20));

    public static final RegistryObject<Item> MUSIC_DISC_ANCIENT_REMNANT = ITEMS.register("music_disc_ancient_remnant",
            () -> new RecordItem(14, ModSounds.REMNANT_MUSIC,new Item.Properties().tab(Cataclysm.TAB).stacksTo(1).rarity(Rarity.EPIC).fireResistant(), 212 * 20));
    ...
    public static final RegistryObject<SpawnEggItem> IGNITED_BERSERKER_SPAWN_EGG = ITEMS.register("ignited_berserker_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.IGNITED_BERSERKER, 4672845, 16579584, new Item.Properties().tab(Cataclysm.TAB)));
    ...
    public static final RegistryObject<SpawnEggItem> CORAL_GOLEM_SPAWN_EGG = ITEMS.register("coral_golem_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.CORAL_GOLEM, 0x2143a4, 0xa4222f, new Item.Properties().tab(Cataclysm.TAB)));

    public static final RegistryObject<SpawnEggItem> CORALSSUS_SPAWN_EGG = ITEMS.register("coralssus_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.CORALSSUS, 0x3f6ce5, 0xedec4c, new Item.Properties().tab(Cataclysm.TAB)));
    ...
    public static final RegistryObject<SpawnEggItem> KOBOLEDIATOR_SPAWN_EGG = ITEMS.register("kobolediator_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.KOBOLEDIATOR, 0xb7b196, 0x945b31, new Item.Properties().tab(Cataclysm.TAB)));

    public static final RegistryObject<SpawnEggItem> WADJET_SPAWN_EGG = ITEMS.register("wadjet_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.WADJET, 0xb7b196, 0xdbb86a, new Item.Properties().tab(Cataclysm.TAB)));
