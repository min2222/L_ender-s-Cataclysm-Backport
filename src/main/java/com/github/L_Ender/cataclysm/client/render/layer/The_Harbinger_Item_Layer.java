...
public class The_Harbinger_Item_Layer extends RenderLayer<The_Harbinger_Entity, The_Harbinger_Model> {
    ...
    public The_Harbinger_Item_Layer(The_Harbinger_Renderer renderIn, AdvancedModelBox AdvancedModelBox, ItemStack itemstack, ItemTransforms.TransformType transformType) {
        super(renderIn);
